    ...
    <div>
      ...
      <div className="flex flex-col items-center justify-center gap-10">
        ...
        <div className="flex flex-col items-center justify-center gap-8 p-10">
          <p className="text-3xl font-semibold italic opacity-70">Department of Artificial Intelligence & Data Science</p>
          <div className="leading-6">
            <p className="font-bold pb-4 text-5xl bg-gradient-to-r from-[#1D4EFE] to-[#1A8DF7] inline-block text-transparent bg-clip-text">
              Project Prakalpa
            </p>
            <p className="opacity-60 font-medium">BE Major Projects, Academic Year 2023-34</p>
          </div>
        </div>
