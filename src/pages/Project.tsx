  ...
  return (
    <div className="flex flex-col justify-between p-6 md:p-14 md:gap-10 md:flex-row">
        <div className="flex flex-col gap-8">
            ...
            <div>
              <iframe className="w-full h-[300px] md:min-h-[450px]" src="https://www.youtube.com/embed/WZOAtnI8u_g?si=NLfXUZMyxyvgGMRY" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
            </div>
            <div className="text-left">
              <a className="text-blue-600 italic font-semibold underline" href="http://github.com/" target="_blank" rel="noopener noreferrer">GitHub</a>
            </div>
        </div>
        <Team />
    </div>
